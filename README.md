...
docker run -it pydreamer sh scripts/xvfb_run.sh python3 pydreamer/train.py --configs defaults atari atari_pong
```
...
```sh
python pydreamer/train.py --configs defaults atari --env_id Atari-Pong --gamma 0.995
```
